...
import tools.mo3ta.handyview.util.DateTiemHelper
...
class DateTiemHelperTest {
    ...
    fun `isAfter() check that time is After `() {
        ...
        // act
        val res =
            DateTiemHelper.isAfterOrEqual(afterHour, afterMinutes, cuurentHour, cuurentMinutes)
    ...
    fun `isBeforeOrEqual() check that time  is Before `() {
        ...
        // act
        val res =
            DateTiemHelper.isBeforeOrEqual(afterHour, afterMinutes, cuurentHour, cuurentMinutes)
